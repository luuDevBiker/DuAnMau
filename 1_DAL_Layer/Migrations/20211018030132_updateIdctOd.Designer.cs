...
namespace _1_DAL_Layer.Migrations
{
    ...
    [Migration("20211018030132_updateIdctOd")]
    partial class updateIdctOd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_1_DAL_Layer.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("_1_DAL_Layer.Entities.Employee", b =>
                {
                    b.Property<string>("Ep_Code")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("_1_DAL_Layer.Entities.Products", b =>
                {
                    b.Property<string>("Prd_Code")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("_1_DAL_Layer.Entities.Customer", b =>
                {
                    b.HasOne("_1_DAL_Layer.Entities.Employee", "Employee")
                        .WithMany("Customer")
            ...
            modelBuilder.Entity("_1_DAL_Layer.Entities.Customer_Order", b =>
                {
                    b.HasOne("_1_DAL_Layer.Entities.Customer", null)
            ...
            modelBuilder.Entity("_1_DAL_Layer.Entities.Customer_Order_Details", b =>
                {
                    ...
                    b.HasOne("_1_DAL_Layer.Entities.Products", "Products")
